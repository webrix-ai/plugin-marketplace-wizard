...
export function AgentDetailView({
  ...
  const handleSave = () => {
    ...
    const maxTurnsNum = maxTurns.trim()
      ? parseInt(maxTurns.trim(), 10)
      : undefined
    ...
    updateAgentInPlugin(pluginId, agent.id, {
      ...
      model: model || undefined,
      permissionMode:
        (permissionMode as AgentData["permissionMode"]) || undefined,
      maxTurns: maxTurnsNum,
  ...
  const handleEditorSave = useCallback(
    (newContent: string) => {
      ...
      updateAgentInPlugin(pluginId, agent.id, {
        ...
        permissionMode:
          (fm.permissionMode as AgentData["permissionMode"]) || undefined,
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div className="flex flex-col gap-1">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setPermissionMode((v ?? "") === "__none__" ? "" : (v ?? ""))
                  }
                >
                  <SelectTrigger className="h-7 w-full text-xs">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="flex flex-col gap-1">
                ...
                <Input
                  value={maxTurns}
                  onChange={(e) =>
                    setMaxTurns(e.target.value.replace(/[^0-9]/g, ""))
                  }
                  className="h-7 text-xs"
