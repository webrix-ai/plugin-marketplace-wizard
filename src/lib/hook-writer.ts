...
function buildHandlerObj(handler: ClaudeHookHandler): Record<string, unknown> {
  ...
  if (handler.type === "command") {
    ...
    if (handler.run_in_background !== undefined) obj["run_in_background"] = handler.run_in_background;
    if (handler.statusMessage !== undefined) obj["statusMessage"] = handler.statusMessage;
...
function buildCursorHookObj(item: Omit<CursorHookItem, "id">): Record<string, unknown> {
