...
export const BorderLoadingIndicator = ({
  ...
  return (
    <>
      <div className="pointer-events-none absolute -top-px -left-px h-[calc(100%+2px)] w-[calc(100%+2px)]">
        <style>
          {`
        @keyframes spin {
...
const StatusBorder = ({
  ...
  return (
    <>
      <div
        className={cn(
          "pointer-events-none absolute -top-px -left-px h-[calc(100%+2px)] w-[calc(100%+2px)] rounded-[9px] border-2",
          className,
        )}
      />
      {children}
